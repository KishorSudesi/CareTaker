...
public class ChromeHelpPopup {
    ...
    public ChromeHelpPopup(Context context, String text, int viewResource) {
        mContext = context; mWindow = new PopupWindow(context);
    ...
    public void show(View anchor) {
        ...
        if (anchorRect.top < screenHeight / 2) {
            yPos = anchorRect.bottom; onTop = false;
        }
        ...
        } else { mHelpTextView.setMaxHeight(screenHeight - yPos); }
        ...
        public void setContentView(View root) {
            mView = root; mWindow.setContentView(root);
        }
